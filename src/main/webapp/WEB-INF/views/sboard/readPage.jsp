...
<script>
	...
	$(document).ready(function() {
		...
		$("#sbordModify").on("click", function() {
			formObj.attr("action", "/sboard/modifyPage");
			formObj.attr("method", "get");
			formObj.submit();
		});

		$("#sbordRemove").on("click", function() {
...
<section class="content">
	...
	<div class="box-footer">
		<button type="submit" class="btn btn-warning" id="sbordModify">Modify</button>
		<button type="submit" class="btn btn-danger" id="sbordRemove">REMOVE</button>
